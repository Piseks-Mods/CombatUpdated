...
public enum TremorType {
    BASE(StatusEffectCapability.EffectType.TREMOR), EVERLASTING(StatusEffectCapability.EffectType.TREMOR_EVERLASTING), SCORCH(StatusEffectCapability.EffectType.TREMOR_SCORCH), DECAY(StatusEffectCapability.EffectType.TREMOR_DECAY);
